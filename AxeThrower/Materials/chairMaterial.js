...
function chairMatSetup(){
    var shader = initShaders( gl, "vertex-phrongLighting", "fragment-phrongLighting" );

    var chairMaterial = new Material( shader );

    chairMaterial.ka = new Vector3( 0.5, 0.5, 0.5 );
    chairMaterial.kd = new Vector3( 0.5, 0.5, 0.5 );
    chairMaterial.ks = new Vector3( 1.0, 1.0, 1.0 );
    chairMaterial.alpha = 4.0;
    chairMaterial.Ia = new Vector3( 0.5, 0.5, 0.5 );
    chairMaterial.Id = new Vector3( 0.5, 0.5, 0.5 );
    chairMaterial.Is = new Vector3( 0.4, 0.4, 0.4 );
    chairMaterial.abcDist = new Vector3( .05, 0.0, 0.0 );

    chairMaterial.renderSetup = chairRenderSetup;
    chairMaterial.render = chairRender;
